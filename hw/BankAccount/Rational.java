...
public class Rational implements Comparable {
  ...
  public boolean equals( Object other ) {
    ...
    //...thus allowing for direct comparison of attributes
	  ...
	  Rational ans = (Rational) other;
	  ans.reduce();
	  return (floatValue() == ans.floatValue()); // if the two are equal, return
      }
      else {
	  return false;
      }
  ...
  public int compareTo( Object other ) {
    ...
    // This will exit the function, generating a runtime error
      ...
      if ((other instanceof Rational) == false) {
	  throw new ClassCastException ("\nnot of class Rational");
      }
      Rational ans = (Rational) other;
      int a = _numerator * ans._denominator; //cross multiply
      int b = _denominator * ans._numerator;
